...
public class SleepTimerDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View rootView = View.inflate(getActivity(), R.layout.player_sleep_timer_dialog, null);
        builder.setView(rootView);

        colorOn = UtilsUI.getAttrColor(this.getActivity().getTheme(), com.google.android.material.R.attr.colorPrimary);
