...
class VolumePopupWindow extends PopupWindow {
    ...
    public VolumePopupWindow(LayoutInflater inflater, View anchor) {
        ...
        View rootView = View.inflate(anchor.getContext(), R.layout.player_media_controls_volume_dialog, null);
    ...
    public void onVolumeMuteChanged(boolean state, boolean audioEffectsActiveState) {
        ...
        if (state)
            muteButton.setColorFilter(UtilsUI.getAttrColor(muteButton, com.google.android.material.R.attr.colorPrimary));
        else
            muteButton.setColorFilter(UtilsUI.getAttrColor(muteButton, com.google.android.material.R.attr.colorPrimary));
    }
    ...
    public void onEqStateChanged(boolean state) {
        if (state)
            eqButton.setColorFilter(UtilsUI.getAttrColor(muteButton, com.google.android.material.R.attr.colorSecondary));
        else
            eqButton.setColorFilter(UtilsUI.getAttrColor(muteButton, com.google.android.material.R.attr.colorPrimary));
    }
}
