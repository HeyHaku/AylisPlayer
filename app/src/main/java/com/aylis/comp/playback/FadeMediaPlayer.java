...
public class FadeMediaPlayer {
    ...
    private float fadeSpeed = ((tickMs + 10) * 0.001f) / fadeInSeconds;
    ...
    static class MyHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            float crossFadeSpeed = ((target.tickMs + 10) * 0.001f) / crossFadeInSeconds;
                    ...
                    if (target.crossFadeDuration >= 0) {
                        ...
                        if (duration1 > target.crossFadeDuration + prepareNextTimeReserve) {
                            ...
                            if (toEnd1 <= target.crossFadeDuration + prepareNextTimeReserve) {
                                long crossFadeAfter = (toEnd1 - target.crossFadeDuration) - 10;
    ...
    public void playNextAtTime(IMediaDataSource path, final boolean start, long seekPos, long atTime) {
        ...
        if (atTime <= 0 || delay <= 0) {
            ...
            if (crossFadeDuration >= 0 && crossFadeDuration > crossFadeTickMs) {
