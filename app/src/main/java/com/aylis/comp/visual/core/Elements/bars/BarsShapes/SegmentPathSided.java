...
public class SegmentPathSided implements ISegmentPath {
    ...
    public void getPointOnPath(int pointIndex, int pointsCount, RectF bounds, PointF pathPointOut, PointF pathPointVecOut) {
        ...
        {
            int currentSide = (int) (sides * progress);
            float sideProgress = progress - ((float) currentSide / (float) sides);
    ...
    public void onApplyCustomization(Element.CustomizationData customizationData) {
        ...
        rotationMeasure = customizationData.getPropertyString("rotationMeasure", rotationMeasure);
    ...
    public void onReadCustomization(Element.CustomizationData outCustomizationData) {
        ...
        outCustomizationData.putPropertyString("rotationMeasure", rotationMeasure == null ? "" : rotationMeasure, "txt");
        outCustomizationData.putPropertyFloat("measureMul", measureMul, "f -100.0 100.0");
    }
}
